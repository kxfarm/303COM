...
public class ManagerUpdateUserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_update_user_profile);
        ...
        etName = (EditText) findViewById(R.id.name4);
        etNIC = (EditText) findViewById(R.id.nic4);
        etPhoneNumber = (EditText) findViewById(R.id.phoneNumber4);

        tvEmail = (TextView) findViewById(R.id.email4);
        tvPosition = (TextView) findViewById(R.id.position4);
        tvDepartment = (TextView) findViewById(R.id.department4);

        updateUser = (Button) findViewById(R.id.btnUpdate4);
    ...
    public void updateUser(){
        if(etName.getText().toString().equals("")){
            ...
            Toast.makeText(ManagerUpdateUserProfile.this, "Details updated successfully", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(getApplicationContext(), ManagerUserProfile.class));
